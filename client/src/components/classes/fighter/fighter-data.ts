export const fd = {
  class: {
    ...
    classFeatures: [
      ...
      'Action Surge||2',
      {
        classFeature: 'Martial Archetype||3',
      ...
      {
        classFeature: 'Martial Archetype feature||7',
        gainSubclassFeature: true,
      },
      'Ability Score Improvement||8',
      'Indomitable||9',
      {
        classFeature: 'Martial Archetype feature||10',
        gainSubclassFeature: true,
      },
      'Extra Attack (2)||11',
      ...
      {
        classFeature: 'Martial Archetype feature||15',
        gainSubclassFeature: true,
      },
      ...
      {
        classFeature: 'Martial Archetype feature||18',
        gainSubclassFeature: true,
      },
    ...
    fluff: [
      ...
      },
      {
        ...
        entries: [
          {
            type: 'quote',
            entries: ["Let me know when you're all done talking."],
            by: 'Tordek',
          },
  ...
  subclassFeature: [
    ...
    },
    {
      ...
      level: 7,
      header: 2,
      entries: ['You gain another superiority die at 7th level.'],
    },
    {
    ...
    },
    {
      ...
      level: 10,
      header: 2,
      entries: ['At 10th level, your superiority dice turn into d10s.'],
    },
    {
      name: 'Additional Maneuvers',
      source: 'PHB',
    ...
    },
    {
      ...
      level: 15,
      header: 2,
      entries: ['You gain another superiority die at 15th level.'],
    },
    {
      name: 'Relentless',
      source: 'PHB',
    ...
    },
    {
      ...
      level: 18,
      header: 2,
      entries: ['At 18th level, your superiority dice turn into d12s.'],
    },
    {
      name: 'Champion',
      source: 'PHB',
