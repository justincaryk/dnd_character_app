...
const buildDescTypeEntries = (desc: any) => {
  return (
    <div
      className="label-text-pair-outer space-sequence-20"
      key={_getRandoNum()}
    >
      <div>{desc.name}.</div>
...
const buildSpellDescriptHtml = (spell: any) => {
  ...
  return <div className="space-sequence-20">{htmlDescriptChunkInner}</div>;
};
  ...
  return (
    <div>
      ...
      <div
        className={
          detailsActive
            ? "spell-detail active space-sequence-20"
            : "spell-detail"
        }
      >
