          ...
          entries: {
            e: [
              ...
              'Some transmuters are tinkerers and pranksters, turning people into toads and transforming copper into silver for fun and occasional profit. Others pursue their magical studies with deadly seriousness, seeking the power of the gods to make and destroy worlds.',
              {
                type: 'refSubclassFeature',
                subclassFeature:
                  'Transmutation Savant|Wizard||Transmutation||2',
              },
              {
                type: 'refSubclassFeature',
          ...
          entries: {
            e: [
              ...
              },
              {
                type: 'refSubclassFeature',
                subclassFeature:
                  'Bladesinger Styles|Wizard||Bladesinging|TCE|2',
              },
            ],
          },
          id: uuidv4(),
          ...
          entries: {
            e: [
              ...
              },
              {
                type: 'refSubclassFeature',
                subclassFeature:
                  'Tentacle of the Deeps|Warlock||Fathomless|TCE|1',
              },
              {
                type: 'refSubclassFeature',
          ...
          entries: {
            e: [
              'Your innate magic manifests in fire. You are your fire, and your fire is you.',
              {
                type: 'refSubclassFeature',
                subclassFeature:
                  'Heart of Fire|Sorcerer||Pyromancer (PSK)|PSK|1',
              },
            ],
          },
          id: uuidv4(),
          ...
          entries: {
            e: [
              ...
              },
              {
                type: 'refSubclassFeature',
                subclassFeature:
                  'Telepathic Speech|Sorcerer||Aberrant Mind|TCE|1',
              },
            ],
          },
          id: uuidv4(),
          ...
          entries: {
            e: [
              'The cosmic force of order has suffused you with magic. That power arises from Mechanus or a realm like it-a plane of existence shaped entirely by clockwork efficiency. You, or someone from your lineage, might have become entangled in the machinations of the modrons, the orderly beings who inhabit Mechanus. Perhaps your ancestor even took part in the Great Modron March. Whatever its origin within you, the power of order can seem strange to others, but for you, it is part of a vast and glorious system.',
              {
                type: 'refSubclassFeature',
                subclassFeature:
                  'Clockwork Magic|Sorcerer||Clockwork Soul|TCE|1',
              },
              {
                type: 'refSubclassFeature',
                subclassFeature:
                  'Restore Balance|Sorcerer||Clockwork Soul|TCE|1',
              },
            ],
          },
          id: uuidv4(),
          ...
          entries: {
            e: [
              ...
              },
              {
                type: 'refSubclassFeature',
                subclassFeature:
                  'Favored by the Gods|Sorcerer||Divine Soul|XGE|1',
              },
            ],
          },
          id: uuidv4(),
          ...
          entries: {
            e: [
              ...
              },
              {
                type: 'refSubclassFeature',
                subclassFeature:
                  'Mage Hand Legerdemain|Rogue||Arcane Trickster||3',
              },
            ],
          },
          id: uuidv4(),
                ...
                entries: [
                  {
                    type: 'refSubclassFeature',
                    subclassFeature:
                      'Psi-Bolstered Knack|Rogue|TCE|Soulknife|TCE|3',
                  },
                  {
                    type: 'refSubclassFeature',
                    subclassFeature:
                      'Psychic Whispers|Rogue|TCE|Soulknife|TCE|3',
                  },
                ],
              },
            ],
              ...
              'At 15th level, you gain one of the following features of your choice.',
              {
                ...
                entries: [
                  ...
                  },
                  {
                    type: 'refSubclassFeature',
                    subclassFeature:
                      'Stand Against the Tide|Ranger||Hunter||15',
                  },
                  {
                    type: 'refSubclassFeature',
          ...
          entries: {
            e: [
              ...
              },
              {
                type: 'refSubclassFeature',
                subclassFeature:
                  'Fey Wanderer Magic|Ranger||Fey Wanderer|TCE|3',
              },
              {
                type: 'refSubclassFeature',
                subclassFeature:
                  'Otherworldly Glamour|Ranger||Fey Wanderer|TCE|3',
              },
            ],
          },
          id: uuidv4(),
          ...
          entries: {
            e: [
              'Gloom Stalkers are at home in the darkest places: deep under the earth, in gloomy alleyways, in primeval forests, and wherever else the light dims. Most folk enter such places with trepidation, but a Gloom Stalker ventures boldly into the darkness, seeking to ambush threats before they can reach the broader world. Such rangers are often found in the Underdark, but they will go any place where evil lurks in the shadows.',
              {
                type: 'refSubclassFeature',
                subclassFeature:
                  'Gloom Stalker Magic|Ranger||Gloom Stalker|XGE|3',
              },
              {
                type: 'refSubclassFeature',
          ...
          entries: {
            e: [
              'Horizon Walkers guard the world against threats that originate from other planes or that seek to ravage the mortal realm with otherworldly magic. They seek out planar portals and keep watch over them, venturing to the Inner Planes and the Outer Planes as needed to pursue their foes. These rangers are also friends to any forces in the multiverse—especially benevolent dragons, fey, and elementals—that work to preserve life and the order of the planes.',
              {
                type: 'refSubclassFeature',
                subclassFeature:
                  'Horizon Walker Magic|Ranger||Horizon Walker|XGE|3',
              },
              {
                type: 'refSubclassFeature',
          ...
          entries: {
            e: [
              'You have dedicated yourself to hunting down creatures of the night and wielders of grim magic. A Monster Slayer seeks out vampires, dragons, evil fey, fiends, and other magical threats. Trained in supernatural techniques to overcome such monsters, slayers are experts at unearthing and defeating mighty, mystical foes.',
              {
                type: 'refSubclassFeature',
                subclassFeature:
                  'Monster Slayer Magic|Ranger||Monster Slayer|XGE|3',
              },
              {
                type: 'refSubclassFeature',
          ...
          entries: {
            e: [
              ...
              'A paladin must be evil and at least 3rd level to become an Oathbreaker. The paladin replaces the features specific to his or her Sacred Oath with Oathbreaker features.',
              {
                type: 'refSubclassFeature',
                subclassFeature:
                  'Oathbreaker Spells|Paladin||Oathbreaker|DMG|3',
              },
              {
                type: 'refSubclassFeature',
                subclassFeature:
          ...
          entries: {
            e: [
              ...
              "Paladins who follow the Watchers' oath are ever vigilant in spotting the influence of extraplanar forces, often establishing a network of spies and informants to gather information on suspected cults. To a Watcher, keeping a healthy suspicion and awareness about one's surroundings is as natural as wearing armor in battle.",
              {
                type: 'refSubclassFeature',
                subclassFeature:
                  'Tenets of the Watchers|Paladin||Watchers|TCE|3',
              },
              {
                type: 'refSubclassFeature',
          ...
          entries: {
            e: [
              ...
              'While redeemers are idealists, they are no fools. Redeemers know that undead, demons, devils, and other supernatural threats can be inherently evil. Against such foes, paladins who swear this oath bring the full wrath of their weapons and spells to bear. Yet the redeemers still pray that, one day, even creatures of wickedness will invite their own redemption.',
              {
                type: 'refSubclassFeature',
                subclassFeature:
                  'Tenets of Redemption|Paladin||Redemption|XGE|3',
              },
              {
                type: 'refSubclassFeature',
          ...
          entries: {
            e: [
              ...
              'Many monks of this tradition tattoo their bodies with representations of their ki powers, commonly imagined as coiling dragons, but also as phoenixes, fish, plants, mountains, and cresting waves.',
              {
                type: 'refSubclassFeature',
                subclassFeature:
                  'Disciple of the Elements|Monk||Four Elements||3',
              },
              {
                type: 'refSubclassFeature',
          ...
          entries: {
            e: [
              'A monk who follows the Way of the Astral Self believes their body is an illusion. They see their ki as a representation of their true form, an astral self. This astral self has the capacity to be a force of order or disorder, with some monasteries training students to use their power to protect the weak and other instructing aspirants in how to manifest their true selves in service to the mighty.',
              {
                type: 'refSubclassFeature',
                subclassFeature:
                  'Forms of Your Astral Self|Monk||Astral Self|TCE|3',
              },
              {
                type: 'refSubclassFeature',
                subclassFeature:
                  'Arms of the Astral Self|Monk||Astral Self|TCE|3',
              },
            ],
          },
          id: uuidv4(),
          ...
          entries: {
            e: [
              ...
              'A drunken master often enjoys playing the fool to bring gladness to the despondent or to demonstrate humility to the arrogant, but when battle is joined, the drunken master can be a maddening, masterful foe.',
              {
                type: 'refSubclassFeature',
                subclassFeature:
                  'Bonus Proficiencies|Monk||Drunken Master|XGE|3',
              },
              {
                type: 'refSubclassFeature',
              ...
              'Starting at 6th level, you can move in sudden, swaying ways. You gain the following benefits.',
              {
                ...
                entries: [
                  ...
                  },
                  {
                    type: 'refSubclassFeature',
                    subclassFeature:
                      'Redirect Attack|Monk|XGE|Drunken Master|XGE|6',
                  },
                ],
              },
            ],
          ...
          entries: {
            e: [
              ...
              },
              {
                type: 'refSubclassFeature',
                subclassFeature:
                  'Unleash Incarnation|Fighter||Echo Knight|EGW|3',
              },
            ],
          },
          id: uuidv4(),
          ...
          entries: {
            e: [
              ...
              },
              {
                type: 'refSubclassFeature',
                subclassFeature:
                  'Maneuver Options|Fighter||Battle Master||3|TCE',
              },
            ],
          },
          id: uuidv4(),
                ...
                entries: [
                  {
                    type: 'refSubclassFeature',
                    subclassFeature:
                      'Protective Field|Fighter|TCE|Psi Warrior|TCE|3',
                  },
                  {
                    type: 'refSubclassFeature',
                    subclassFeature:
                      'Psionic Strike|Fighter|TCE|Psi Warrior|TCE|3',
                  },
                  {
                    type: 'refSubclassFeature',
                    subclassFeature:
          ...
          entries: {
            e: [
              "Rune Knights enhance their martial prowess using the supernatural power of runes, an ancient practice that originated with giants. Rune cutters can be found among any family of giants, and you likely learned your methods first or second hand from such a mystical artisan. Whether you found the giant's work carved into a hill or cave, learned of the runes from a sage, or met the giant in person, you studied the giant's craft and learned how to apply magic runes to empower your equipment.",
              {
                type: 'refSubclassFeature',
                subclassFeature:
                  'Bonus Proficiencies|Fighter||Rune Knight|TCE|3',
              },
              {
                type: 'refSubclassFeature',
          ...
          entries: {
            e: [
              ...
              },
              {
                type: 'refSubclassFeature',
                subclassFeature:
                  'Arcane Shot Options|Fighter||Arcane Archer|XGE|3',
              },
            ],
          },
          id: uuidv4(),
          ...
          entries: {
            e: [
              'At 3rd level, you learn magical theory or some of the secrets of nature—typical for practitioners of this elven martial tradition. You choose to gain proficiency in either the Arcana or the Nature skill, and you choose to learn either the prestidigitation or the druidcraft cantrip.',
              {
                type: 'skillOptions',
                count: 1,
                options: [{ name: 'Arcana' }, { name: 'Nature' }],
              },
              {
                type: 'cantrips',
                options: {
          ...
          entries: {
            e: [
              ...
              },
              {
                type: 'refSubclassFeature',
                subclassFeature:
                  'Blessing of the Trickster|Cleric||Trickery||1',
              },
            ],
          },
          id: uuidv4(),
          ...
          entries: {
            e: [
              'When you choose this domain at 1st level, you gain proficiency with heavy armor. You also gain proficiency in the Intimidation or Persuasion skill (your choice).',
              {
                type: 'skillOptions',
                count: 1,
                options: [{ name: 'Intimidation' }, { name: 'Persuasion' }],
              },
            ],
          },
          id: uuidv4(),
              ...
              'Your totem animal might be an animal related to those listed here but more appropriate to your homeland. For example, you could choose a hawk or vulture in place of an eagle.',
              {
                ...
                entries: [
                  ...
                  },
                  {
                    type: 'refSubclassFeature',
                    subclassFeature:
                      'Tiger|Barbarian|SCAG|Totem Warrior||3|SCAG',
                  },
                  {
                    type: 'refSubclassFeature',
              ...
              'At 6th level, you gain a magical benefit based on the totem animal of your choice. You can choose the same animal you selected at 3rd level or a different one.',
              {
                ...
                entries: [
                  ...
                  },
                  {
                    type: 'refSubclassFeature',
                    subclassFeature:
                      'Tiger|Barbarian|SCAG|Totem Warrior||6|SCAG',
                  },
                  {
                    type: 'refSubclassFeature',
              ...
              'At 14th level, you gain a magical benefit based on a totem animal of your choice. You can choose the same animal you selected previously or a different one.',
              {
                ...
                entries: [
                  ...
                  },
                  {
                    type: 'refSubclassFeature',
                    subclassFeature:
                      'Elk|Barbarian|SCAG|Totem Warrior||14|SCAG',
                  },
                  {
                    type: 'refSubclassFeature',
                    subclassFeature:
                      'Tiger|Barbarian|SCAG|Totem Warrior||14|SCAG',
                  },
                  {
                    type: 'refSubclassFeature',
          ...
          entries: {
            e: [
              ...
              },
              {
                type: 'refSubclassFeature',
                subclassFeature:
                  'Battlerager Armor|Barbarian||Battlerager|SCAG|3',
              },
            ],
          },
          id: uuidv4(),
